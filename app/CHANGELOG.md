...
- AI suggestions: select or deselect all proposals with one tap in the app bar, a banner announces proposed rules (previously easy to scroll past below the category list), and the apply button breaks its count into categories and rules
